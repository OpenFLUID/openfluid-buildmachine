...
class BuildMachine :
    ...
    def logCommand(self, Step, Command, Title="", CommandCwd=''):
        ...
        ReturnCode = utils.subprocessCall(Command, FilePath, CommandCwd, self.OutputInShell)
    ...
    def processBuildOptions(self):
        ...
        if self.BuildType == "package":
            PackageCommand = ["cmake",self.AllCodebaseRepos["openfluid_repos"].LocalPath,"-DCMAKE_BUILD_TYPE=Release"]
    ...
    def setupRepos(self, TriggerClone=True):
        ...
        # set up log folder
        utils.resetDirectory(self.BaseTempPath, Purge=True)  # No purge to avoid data erasing on the temp directory
        utils.resetDirectory(self.LogPath, Purge=True)  # Purge of the log directory
    ...
    def checkROpenFLUID(self):
        ...
        self.logCommandAndCheck(Step, Command, Header, CommandCwd=RRepos)
    ...
    def checkPyOpenFLUID(self):
        ...
        self.logCommandAndCheck(Step, Command, Header, CommandCwd=PyRepos)
    ...
    def buildOpenFLUIDJS(self):
        ...
        self.logCommandAndCheck(Step, Command, Header, CommandCwd=JSRepos)
